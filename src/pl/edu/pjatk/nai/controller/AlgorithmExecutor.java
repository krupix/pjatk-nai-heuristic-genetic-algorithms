...
import pl.edu.pjatk.nai.algorithm.GeneticAlgorithmImpl;
import pl.edu.pjatk.nai.algorithm.HillClimbingAlgorithmImpl;
import pl.edu.pjatk.nai.graph.GraphGenerator;

/**
 * Piotr Osiadacz, s11562 on 30.01.2016.
 */
public class AlgorithmExecutor {
    ...
    private static int ALGORITHM_STEPS = 10000;
...
//        graph = graphGenerator.loadFromFile("/Users/krupix/KruPiX/dev/git/pjatk-nai-project2/graphs/myciel4.col");
//        graph = graphGenerator.loadFromFile("/Users/krupix/KruPiX/dev/git/pjatk-nai-project2/graphs/myciel3.col");
...
//        graph = graphGenerator.loadFromFile("/Users/krupix/KruPiX/dev/git/pjatk-nai-project2/graphs/games120.col");
    ...
    private void generateFromGenerators() {
        ...
        Generator bt = new GridGenerator();
